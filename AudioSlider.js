...
import { TouchableOpacity, Animated, PanResponder, View, Easing, Dimensions } from "react-native";
import { Audio } from 'expo-av';
import { Entypo, MaterialIcons } from '@expo/vector-icons';
import sleep from './sleep.js';
import DigitalTimeString from './DigitalTimeString.js';


//----------------------------------------
//----------------------------------------
// THE AUDIOSLIDER COMPONENT
//----------------------------------------
//----------------------------------------


// this component contains the audio slider progress bar that is displayed for every prayer 
// the user accesses. 
        ...
        return (
            <View
                style={{
                    ...
                    alignItems: 'stretch',
                    paddingLeft: Dimensions.get('window').width*.015,
                    paddingRight: Dimensions.get('window').width*.015,
                }}
            >
                ...
                >
                    ...
                    <TouchableOpacity
                        style={{
                            ...
                            alignItems: 'center',
                            paddingRight: Dimensions.get('window').height*.025,
                            zIndex: 2
                        }}
                    ...
                    >
                        {
                            this.state.playing
                                ?
                                <MaterialIcons name="pause" size={Dimensions.get('window').height*.035} color="white" />
                                :
                                <Entypo name="controller-play" size={Dimensions.get('window').height*.035} color="#a7e7fa" />
                        }
                    </TouchableOpacity>
